...
clear='\033[0m'
banner() {
echo -e "${Red} _______  _______  _______  _______ ________${Black}__________ _______  _______  _______  _        _______  _______ 
${Red}(  ____ \(       )(  ___  )(  ____ )\__   __/${Black}\__   __/(  ____ )(  ___  )(  ____ \| \    /\(  ____ \(  ____ )
${Red}| (    \/| () () || (   ) || (    )|   ) (   ${Black}   ) (   | (    )|| (   ) || (    \/|  \  / /| (    \/| (    )|
${Red}| (_____ | || || || (___) || (____)|   | |   ${Black}   | |   | (____)|| (___) || |      |  (_/ / | (__    | (____)|
${Red}(_____  )| |(_)| ||  ___  ||     __)   | |   ${Black}   | |   |     __)|  ___  || |      |   _ (  |  __)   |     __)
${Red}      ) || |   | || (   ) || (\ (      | |   ${Black}   | |   | (\ (   | (   ) || |      |  ( \ \ | (      | (\ (   
